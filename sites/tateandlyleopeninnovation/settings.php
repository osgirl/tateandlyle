 ...
 * @endcode
 */
$settings['hash_salt'] = 'E7gZ18p7d9aMmSUrncIAkvHoxBasgFkJBcHEX5nznH1YmkUlBPYVV3M';
...
if ($is_ah_env && file_exists('/var/www/site-php')) {
  require "/var/www/site-php/{$_ENV['AH_SITE_GROUP']}/tateandlyleopeninnovation-settings.inc";
}

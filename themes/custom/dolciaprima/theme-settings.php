...
/**
 * @file
 * Custom theme settings for the Dolciaprima sub-theme.
 */
 ...
 */
function dolciaprima_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
 ...
 */
function dolciaprima_logo_validate($element, FormStateInterface $form_state) {
  global $base_url;
  $languages = \Drupal::languageManager()->getLanguages($flags = 1);
  foreach ($languages as $language) {

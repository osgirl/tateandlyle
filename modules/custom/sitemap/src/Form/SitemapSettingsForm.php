...
class SitemapSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['sitemap_content']['translated_menu'] = array(
      '#type' => 'checkbox',
      '#title' => $this->t('Translated menu'),
      '#default_value' => $config->get('translated_menu'),
      '#description' => $this->t('Check this if the menu which builds the sitemap is a translated menu. Leave blank for separate menus.'),
    );

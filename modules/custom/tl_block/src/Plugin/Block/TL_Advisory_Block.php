 ...
 * )
 */
class TL_Advisory_Block extends BlockBase {
  public function build() {
    return array('#markup' => t('Prospective purchasers are advised to conduct their own tests, studies, and regulatory review to determine the fitness of Tate & Lyle products for their particular purposes,

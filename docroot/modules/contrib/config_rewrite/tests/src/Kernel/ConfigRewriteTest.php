...
class ConfigRewriteTest extends KernelTestBase {
   ...
   * @var array
   */
  public static $modules = ['system', 'user', 'config_rewrite', 'config_rewrite_test', 'config_rewrite_test_rewrite'];
  ...
  protected function setUp() {
    ...
    $this->installConfig(['config_rewrite_test']);
  }
